 ...
 */
function retro_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['retro_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('retro sample setting'),
  '#default_value' => theme_get_setting('retro_example'),
